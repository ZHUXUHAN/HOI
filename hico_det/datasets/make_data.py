...
def crop_people(mode):
    img_hoi_train = pd.DataFrame.from_csv('./data/anno_box_{}.csv'.format(mode))
...
def make_80obj_data(mode):
    ...
    for index, row in img_hoi.iterrows():
        ...
        if not os.path.exists(obj_dir):
            os.mkdir(obj_dir)
        region.save(os.path.join('/home/priv-lab1/workspace/zxh/HOI/hico_det/data/obj_crop_imgs/{}'.format(obj), '{}_{}.jpg'.format(name,str(obj_dict[obj]))))



if __name__ == '__main__':
    # make_groundtruth_txt('/home/priv-lab1/workspace/zxh/HOI/hico_det/data/hico_data/final_test_data.csv','/home/priv-lab1/workspace/zxh/HOI/hico_det/results/map/multi_all/ground_truth/',classes_num=600)
