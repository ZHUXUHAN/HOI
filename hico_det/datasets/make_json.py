...
import numpy as np
import json
gt_data_path =  "./data/anno_box_test.csv"
hoi_list_path = "./data/origin_lists/hico_list_hoi.txt"
img_path = '/home/priv-lab1/workspace/zxh/My_Database/hico_20160224_det/images/test2015/'  # image folder path
save_json_path = './data/test_hico.json'  # name for save json
